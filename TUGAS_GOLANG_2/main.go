...
func weatherForecastHandler(c echo.Context) error {
	apiKey := "cc0a364fa16d48d0941135837230311" // Ganti dengan kunci API WeatherAPI.com yang kita miliki
	...
	// Format data cuaca dan kirim sebagai respons sesuai format yang  diinginkan.
